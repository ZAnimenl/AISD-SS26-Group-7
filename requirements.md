...
- **REQ-55** The frontend shall not be responsible for creating, storing, or trusting a real `session_id`; any first-MVP attempt state in the frontend shall be mock-only.
