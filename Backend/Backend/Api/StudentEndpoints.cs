...
public static class StudentEndpoints
{
        ...
        return results
            ...
            .Select(group =>
            {
                ...
                return new StudentResultSummary(
                    ...
                    AiGradingSummary: session.AiGradingSummary,
                    AiGradingConfidence: session.AiGradingConfidence,
                    AiGradingDetails: JsonDocumentSerializer.Deserialize(session.AiGradingDetailsJson, new Dictionary<string, object>()),
    ...
    internal sealed record StudentResultSummary(
        ...
        string? AiGradingSummary,
        string? AiGradingConfidence,
        IReadOnlyDictionary<string, object> AiGradingDetails,
